...
% Generamos la matriz necesaria
datos = csvread('data_ps2.csv',1,0);
...
X = [outside id dis edMad edMad_mths edMad_miss choice dummies];

% EdMad - 4 5 6

beta_start_b = [-0.094 -.2 .2 .2];
delta_start = ones(1,369);
delta_start(1:4) = beta_start_b;
